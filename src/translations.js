const translations = {
  en: {
    ...
    cfgPackagingColor1: 'Box & exterior (Shade 1):',
    cfgPackagingColor2: 'Inner layers (Shade 2):',
    cfgPackagingColor3: 'Ribbon (Shade 3):',
  ...
  ro: {
    ...
    specs: [
      ...
      { icon: '◇', title: 'Finisaje Personalizate', desc: 'Ștanțare cu folie la cald, embosare, debosare, UV și acoperiri speciale.' },
    ...
    cfgPackagingColor1: 'Cutia și exteriorul (Nuanța 1):',
    cfgPackagingColor2: 'Straturile finale (Nuanța 2):',
    cfgPackagingColor3: 'Panglica (Nuanța 3):',
